    ...
    <div className="relative w-full flex flex-col items-center justify-center select-none py-6 sm:py-10">
      ...
      <div className="flex items-center gap-3 mt-6 sm:mt-8 z-30">
        ...
        >
          ...
          />
          <ArrowLeft className="relative z-10 h-3 w-3 text-black/60 dark:text-white/80 group-hover:text-black/80 dark:group-hover:text-white transition-colors duration-200" />
        </button>
        ...
        >
          <span
            className="absolute inset-0 rounded-full
                       ...
                       group-hover:from-white/80 group-hover:to-white/25 dark:group-hover:from-white/25 dark:group-hover:to-white/5"
          />
          <ArrowRight className="relative z-10 h-3 w-3 text-black/60 dark:text-white/80 group-hover:text-black/80 dark:group-hover:text-white transition-colors duration-200" />
        </button>
      </div>
    </div>
  );
